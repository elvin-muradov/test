                        ...
                        <form action="{{ route('posts.update', $post->slug) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="w-full flex gap-4">
                                ...
                                <div class="my-4 w-full">
                                    ...
                                    <select id="category" name="cat"
                                        ...
                                        @foreach ($cats as $cat)
                                            <option @if ($post->category->id === $cat->id) selected @endif
                                                value="{{ $cat->id }}">
                                                {{ $cat->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="w-full">
                                <div class="my-2">
                                    ...
                                    <select id="tags" name="tags[]"
                                        ...
                                        @foreach ($post->tags as $postTag)
                                            @foreach ($tags as $tag)
                                                <option @if ($postTag->id === $tag->id) selected @endif
                                ...
                                <img id="pp" class="max-w-lg h-auto mx-auto"
                                    @if ($post->image != null) src="{{ url('post_images/' . $post->image) }}" @else src="{{ asset('assets/template/images/blog_img.jpg') }}" @endif>
                                <div class="my-2">
                            ...
                            <button type="submit"
                                ...
                                <svg class="mr-1 -ml-1 w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
